...
- **Frugal:** called only on meaningful state changes / on-demand, results cached — not every 1.5s tick. Read-only + seldom + metered is about as far from a "bypass" pattern as it gets.
